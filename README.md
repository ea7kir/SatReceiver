...
SatReceiver, together with [SatController](https://github.com/ea7kir/SatController) and [SatServer](https://github.com/ea7kir/SatServer), will be a system for controlling and Digital Amateur Television (DATV) equipment over a wired local area network.
